...
class Database {
  ...
  initializeCoupleData(db, userId, budgetLimit, weddingDate, location, theme) {
    ...
    const baseTasks = [
      ...
      { title: 'Launch wedding website and add countdown', category: 'Misc', period: '9 Months', completed: false, dueDate: '2026-10-20', notes: 'Using Elysian countdown page builder.', assignedTo: 'Groom' },
      ...
      { title: 'Schedule hair and makeup trials', category: 'Hair & Makeup', period: '3 Months', completed: false, dueDate: '2027-05-01', notes: 'Trial booked with Elysian Beauty.', assignedTo: 'Bride' },
      ...
      { title: 'Write wedding vows and practice speeches', category: 'Officiant', period: '1 Month', completed: false, dueDate: '2027-07-01', notes: 'Elysian AI vow assistant draft done.', assignedTo: 'Both' },
    ...
    const baseVendors = [
      ...
      { id: 'v_init_6', name: 'Elysian Floral Design', category: 'Florals', rating: 4.8, reviewsCount: 37, costRange: '$$$', location: 'Beverly Hills, CA', status: 'Shortlisted', contactName: 'Elena Rostova', email: 'elena@elysianflorals.com', phone: '(555) 011-8843', website: 'https://elysianflorals.com', contractPrice: 5000, paidAmount: 0, nextPaymentDate: null, notes: 'Elena is great.' },
